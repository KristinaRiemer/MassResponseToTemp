...
download_VN = function(raw_file_path){
  ...
  if(!file.exists(raw_file_path)){
    ...
    amphibians_query = "SELECT scientificname, class, ordered, family, year, decimallongitude, decimallatitude, massing, citation, license, isfossil, underivedlifestage FROM vertnet_amphibians_amphibians WHERE massing IS NOT NULL"
    birds_query = "SELECT scientificname, class, ordered, family, year, decimallongitude, decimallatitude, massing, citation, license, isfossil, underivedlifestage FROM vertnet_birds_birds WHERE massing IS NOT NULL"
    mammals_query = "SELECT scientificname, class, ordered, family, year, decimallongitude, decimallatitude, massing, citation, license, isfossil, underivedlifestage FROM vertnet_mammals_mammals WHERE massing IS NOT NULL"
    reptiles_query = "SELECT scientificname, class, ordered, family, year, decimallongitude, decimallatitude, massing, citation, license, isfossil, underivedlifestage FROM vertnet_reptiles_reptiles WHERE massing IS NOT NULL"
